(function() {
    ...
    function tablaPaginacion(){
        return {
            ...
            template: '<div class="row"><div class="col-md-5"><span class="pull-left medium text-muted" style="margin-top:22px;font-size: 12px;">Mostrando registros {{(tabla.inicio+1)}} al {{tabla.fin}} de un total de {{tabla.totalElementos}} registros</span></div>' +
